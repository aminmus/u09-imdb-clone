            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"> {{$user['id']}}</th>
                        ...
                        <td>
                            <button data-toggle="modal" data-target="#editModal{{$user['id']}}">Edit</button>
                        </td>
                    </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="/admin/users/update/{{$user['id']}}" >
                                                ...
                                                <input class="form-control"type="text" name="email_verified_at" value="{{$user['email_verified_at']}}">
                                                </div>
